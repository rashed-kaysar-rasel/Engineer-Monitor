...
export default function CreateComplaintModal({ projects, open, onOpenChange }: CreateComplaintModalProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        <DialogTitle>Record Client Complaint</DialogTitle>
                        <DialogDescription>
                            Log a new client complaint associated with a project.
                        </DialogDescription>
                    </DialogHeader>
